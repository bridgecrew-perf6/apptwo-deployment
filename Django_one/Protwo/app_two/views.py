...
def registration(request):
    ...
    return render(request,'app_two/registration.html',{ 'user_form': user_form, 'profile_form': profile_form, 'registered': registered })

def users(request):
    return render(request,"app_two/users.html")
